...
import com.leo.appmaster.home.BaseFragmentActivity;
...
public class LoginActivity  extends BaseFragmentActivity {
    ...
    private void init() {
        ...
        // 设置Tab Indicator的颜色
        mPagerSlidingTab.setIndicatorColor(Color.parseColor("#FFCC0000"));
        // 设置选中Tab文字的颜色 (这是我自定义的一个方法)
        mPagerSlidingTab.setSelectedTextColor(Color.parseColor("#FFCC0000"));
        // 取消点击Tab时的背景色
