...
class DeviderLinearLayout extends LinearLayout {
    ...
    public DeviderLinearLayout(Context context, int themeAttr) {
        super(context);

        TypedArray a = context.obtainStyledAttributes(null, LL, themeAttr, 0);
        setDividerDrawable(a.getDrawable(DeviderLinearLayout.LL_DIVIDER));
