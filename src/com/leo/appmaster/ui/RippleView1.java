...
public class RippleView1 extends RelativeLayout {
    ...
    public RippleView1(Context context) {
        this(context, null, 0);
        childView = this;
    }
...
//        super.setOnClickListener(onClickListener);
    ...
    private void setPositionInAdapter() {
        if (rippleInAdapter) {
            positionInAdapter = findParentAdapterView().getPositionForView(RippleView1.this);
        }
    }

    private boolean adapterPositionChanged() {
        if (rippleInAdapter) {
            int newPosition = findParentAdapterView().getPositionForView(RippleView1.this);
     ...
     * Animations
     */
    private Property<RippleView1, Float> radiusProperty
            = new Property<RippleView1, Float>(Float.class, "radius") {
        @Override
        public Float get(RippleView1 object) {
            return object.getRadius();
        }

        @Override
        public void set(RippleView1 object, Float value) {
    ...
    private Property<RippleView1, Integer> circleAlphaProperty
            = new Property<RippleView1, Integer>(Integer.class, "rippleAlpha") {
        @Override
        public Integer get(RippleView1 object) {
            return object.getRippleAlpha();
        }

        @Override
        public void set(RippleView1 object, Integer value) {
...
//                childView.performClick();
        ...
        private void clickAdapterView(AdapterView parent) {
            try {
                final int position = parent.getPositionForView(RippleView1.this);
                final long itemId = parent.getAdapter() != null
                        ? parent.getAdapter().getItemId(position)
                        : 0;
                if (position != AdapterView.INVALID_POSITION) {
                    parent.performItemClick(RippleView1.this, position, itemId);
                }
            } catch (Exception e) {
            }
        }
    ...
    public static class RippleBuilder {
        ...
        public RippleView1 create() {
            RippleView1 layout = new RippleView1(context);
            ...
            if (parent != null && parent instanceof RippleView1) {
