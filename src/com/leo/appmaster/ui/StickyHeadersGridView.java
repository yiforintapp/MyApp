 ...
 * 
 */
public class StickyHeadersGridView extends GridView implements OnScrollListener,
    ...
    static final String TAG = StickyHeadersGridView.class.getSimpleName();
    ...
    protected StickyHeadersAdapterWrapper mAdapter;
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        StickyHeadersAdapter baseAdapter = (StickyHeadersAdapter) adapter;

        this.mAdapter = new StickyHeadersAdapterWrapper(getContext(), this, baseAdapter);
    ...
    private int findMotionHeader(float y) {
        ...
        for (int i = getFirstVisiblePosition(); i <= getLastVisiblePosition();) {
            ...
            if (id == StickyHeadersAdapterWrapper.ID_HEADER) {
    ...
    private void scrollChanged(int firstVisibleItem) {
        ...
        if (childCount != 0) {
            ...
            for (int i = 0; i < childCount; i += mNumMeasuredColumns) {
                ...
                if (mAdapter.getItemId(getPositionForView(child)) == StickyHeadersAdapterWrapper.ID_HEADER
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        for (int i = 0; i < headerPositions.size(); i++) {
            ...
            boolean headerIsStickied = ((StickyHeadersAdapterWrapper.HeaderFillerView)frame).getHeaderId() == mCurrentHeaderId
