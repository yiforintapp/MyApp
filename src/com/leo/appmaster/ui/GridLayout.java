...
public class GridLayout extends ViewGroup {
	...
	private void measureChildWithMargins2(View child, int parentWidthSpec,
		...
		int childWidthSpec = getChildMeasureSpec(parentWidthSpec, mPaddingLeft
				+ mPaddingRight + getTotalMargin(child, true), childWidth);
		int childHeightSpec = getChildMeasureSpec(parentHeightSpec, mPaddingTop
				+ mPaddingBottom + getTotalMargin(child, false), childHeight);
	...
	public static class LayoutParams extends MarginLayoutParams {
		...
		private static final int RIGHT_MARGIN = R.styleable.ViewGroup_MarginLayout_layout_marginRight;
