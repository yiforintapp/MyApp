 ...
 * @author Tonic Artos
 */
public class StickyHeadersAdapterWrapper extends BaseAdapter {
    ...
    private final StickyHeadersAdapter mDelegate;
    ...
    public StickyHeadersAdapterWrapper(Context context, StickyHeadersGridView gridView,
