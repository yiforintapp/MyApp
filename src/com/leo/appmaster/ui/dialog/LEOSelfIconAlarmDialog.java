...
public class LEOSelfIconAlarmDialog extends LEOBaseDialog {
    ...
    public LEOSelfIconAlarmDialog(Context context) {
    ...
    {
        mDialogIcon.setImageResource(iconId);
    }
        ...
        mLeftBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                DialogInterface.OnClickListener lListener = (DialogInterface.OnClickListener) mLeftBtn
                        .getTag();
                lListener.onClick(LEOSelfIconAlarmDialog.this, 0);
            }
        });
    }
        ...
        mRightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                DialogInterface.OnClickListener lListener = (DialogInterface.OnClickListener) mRightBtn
                        .getTag();
                lListener.onClick(LEOSelfIconAlarmDialog.this, 1);
            }
        });
    }
    ...
    private void initUI() {
        View dlgView = LayoutInflater.from(mContext).inflate(
                R.layout.dialog_alarm_selficon, null);
