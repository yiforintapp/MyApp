...
public class EcoGallery extends EcoGalleryAbsSpinner implements GestureDetector.OnGestureListener {
	...
	/**
	 * listener for scroll to center
	 */
	private IGalleryScroll mScrollListener = null;

	public interface IGalleryScroll {
	...
	public EcoGallery(Context context, AttributeSet attrs, int defStyle) {
		...
		float unselectedAlpha = a.getFloat(R.styleable.EcoGallery_galleryUnselectedAlpha, 0.5f);
	...
	void trackMotionScroll(int deltaX) {
		...
		if (mScrollListener != null) {
			mScrollListener.onScrollOffsetToDis(getCenterOfGallery() - getCenterOfView(mSelectedChild));
		}
...
/*		if (!mShouldCallbackDuringFling) {
	...
	public void setScrollListener(IGalleryScroll listener) {
