...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public void setTabRectFunction(TapRectFunction rectFunction) {
        mTapRectFunction = rectFunction;
    }
    ...
    public void setDragClickEnable(boolean enable) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (mIsScrollableViewHandlingTouch/* || mTouchOutSize*/) {
            mDragHelper.cancel();
            return false;
        }
    ...
    public boolean isExpanded() {
        return mSlideState == SlidingUpPanelLayout.PanelState.EXPANDED;
    }
...
//        LeoLog.d(TAG, "dispatchTouchEvent, x: " + ix + " | y: " + iy);
        ...
        if (mSlideState == PanelState.COLLAPSED && action == MotionEvent.ACTION_DOWN) {
            ...
            if (!rect.contains(ix, iy)) {
                mTouchOutSize = true;
            } else if (mTapRectFunction != null) {
                Rect tapRect = mTapRectFunction.getTapRect();
                Rect leftR = new Rect(rect.left, rect.top, tapRect.left, rect.bottom);
                Rect rightR = new Rect(tapRect.right, rect.top, rect.right, rect.bottom);

                mTouchTapLeftOrRight = leftR.contains(ix, iy) || rightR.contains(ix, iy);
            }
        }
