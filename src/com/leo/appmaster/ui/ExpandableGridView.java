...
public class ExpandableGridView extends ExpandableListView {
    ...
    public ExpandableGridView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int numColumns = a.getInt(R.styleable.ExpandableGridView_numColumns, 3);
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
            ...
            for (int i = mNumColumns * childPosition; i < (mNumColumns * (childPosition + 1)); i++, index++) {
                ...
                if (i < groupChildrenCount) {
                    if (cachedChild != null && cachedChild.getVisibility() == View.INVISIBLE) {
                        cachedChild.setVisibility(View.VISIBLE);
                    }
                    child = mInnerAdapter.getChildView(groupPosition, i,
                            i == (groupChildrenCount - 1), cachedChild, parent);
