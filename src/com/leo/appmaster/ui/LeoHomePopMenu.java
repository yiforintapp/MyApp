...
public class LeoHomePopMenu {

    public final static int DIRECTION_DOWN = 1;
    public final static float SMALLWidth = 142.0f;
    public final static float LongWidth = 230.0f;
    public final static float ITEM_HEIGHT = 50f;
    ...
    public void showPopMenu(Activity activity, View anchorView, LayoutStyles styles,
        ...
        if (styles == null) {
            ...
            mStyles.height = DipPixelUtil.dip2px(activity, ITEM_HEIGHT*mItems.size());
            if (mAnimaStyle != -1) {
    ...
    private View buildTabListLayout() {
        ...
        LinearLayout   convertView = (LinearLayout) inflater.inflate(
                R.layout.popmenu_window_home_list_layout, null);
...
//                }
    ...
    private class MenuListAdapter extends BaseAdapter {
        ...
        private int[] mItemImgs = {R.drawable.reset_pasword_icon,R.drawable.question_icon,
                R.drawable.password_normal_icon,R.drawable.settings};
        ...
        public View getView(final int position, View convertView,
            ...
            if (convertView != null) {
                ...
                convertView = inflater.inflate(
                        R.layout.popmenu_window_home_list_item, null);
                mHolder.mItemName = (TextView) convertView.findViewById(R.id.menu_text);
                mHolder.mImageView = (ImageView) convertView.findViewById(R.id.menu_img);
            ...
            mHolder.mImageView.setImageResource(mItemImgs[position]);
            return convertView;
        }
    }
