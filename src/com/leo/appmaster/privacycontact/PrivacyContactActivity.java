...
public class PrivacyContactActivity extends FragmentActivity implements OnClickListener {
        ...
        if (PrivacyContactUtils.FROM_MESSAGE_EVENT.equals(event.eventMsg)) {
            ...
            mTtileBar.setBackViewListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    chanageEditModel();
                    LeoEventBus.getDefaultBus().post(
                            new PrivacyDeletEditEventBus(PrivacyContactUtils.CANCEL_EDIT_MODEL));
                }
            });
