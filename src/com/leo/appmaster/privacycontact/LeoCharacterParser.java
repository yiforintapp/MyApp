 ...
 * 
 */
public class LeoCharacterParser {
    ...
    private static LeoCharacterParser characterParser;
    
    private LeoCharacterParser() {
        
    }

    public static synchronized LeoCharacterParser getInstance() {
        if(characterParser == null) {
            characterParser = new LeoCharacterParser();
        }
