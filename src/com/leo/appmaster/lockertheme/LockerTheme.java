...
public class LockerTheme extends BaseActivity {
        ...
        dialog.setOnClickListener(new OnDiaogClickListener() {
            ...
            public void onClick(int which) {
                if (which == 0) {
                     ...
                     */
                    SharedPreferences mLockerGuideShared = getSharedPreferences("LockerThemeGuide",
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
            ...
            if (mThemes
                ...
                for (int i = 0; i < urls.length; i++) {
                    ...
                    if (mFlagGp) {
                        if (!flag) {
                            // AM-437, may not find the activity to answer the
                            // intent
                            try {
    ...
    private void setLockerGuideShare() {
        Intent intent = new Intent(LockerTheme.this, LockerThemeGuideActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        try {
            startActivity(intent);
        } catch (Exception e) {
