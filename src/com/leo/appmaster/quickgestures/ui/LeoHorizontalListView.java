...
public class LeoHorizontalListView extends AdapterView<ListAdapter> {
    ...
    public LeoHorizontalListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    ...
    private DataSetObserver mDataObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            synchronized (LeoHorizontalListView.this) {
                mDataChanged = true;
            }
            invalidate();
            requestLayout();
    ...
    private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onDown(MotionEvent e) {
            return LeoHorizontalListView.this.onDown(e);
        }

        @Override
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                float velocityY) {
            return LeoHorizontalListView.this.onFling(e1, e2, velocityX, velocityY);
        }
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (isEventWithinView(e, child)) {
                    if (mOnItemLongClicked != null) {
                        mOnItemLongClicked.onItemLongClick(LeoHorizontalListView.this, child,
                                mLeftViewIndex + 1 + i, mAdapter.getItemId(mLeftViewIndex + 1 + i));
                    }
                    break;
                }
