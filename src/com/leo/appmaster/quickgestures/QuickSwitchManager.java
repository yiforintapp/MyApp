    ...
    public synchronized List<BaseInfo> getSwitchList(int switchNum) {
        if (mSwitcherLoaded) {
            ...
            if (restoredData.isEmpty() && !apf.getLoadedSwitchList()) {
                ...
                // 加速，手电筒，亮度，声音，数据，手势设置，蓝牙，wifi，gps，相机，设置
                ...
                switchSetInfo.gesturePosition = 5;
