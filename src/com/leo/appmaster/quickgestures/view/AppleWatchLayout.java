...
public class AppleWatchLayout extends ViewGroup {
    ...
    private Animator iconAnimator(final View targetView) {
        ...
        PropertyValuesHolder pvScaleX = PropertyValuesHolder.ofFloat("scaleX", 0f, 1.2f * scale,
                scale);
        PropertyValuesHolder pvScaleY = PropertyValuesHolder.ofFloat("scaleY", 0f, 1.2f * scale,
                scale);
