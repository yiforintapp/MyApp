...
public class FloatWindowHelper {
    ...
    private static void onTouchAreaShowQuick(int flag, View view) {
        if (flag == -1) {
            ...
            // Animator animationx = ObjectAnimator.ofFloat(contentView,
            // "scaleX", 0.0f, 1.05f,
            // 1.0f);
            // Animator animationy = ObjectAnimator.ofFloat(contentView,
            // "scaleY", 0.0f, 1.05f,
            // 1.0f);
            ...
            // ColorDrawable dw = new ColorDrawable(Color.argb(200, 255, 255,
            // 255));
