...
public class FeedbackActivity extends Activity implements OnClickListener {
    ...
    private void checkCommitable() {
        ...
        mBtnCommit.setBackgroundResource(commitable ? R.drawable.check_update_button : R.drawable.update_btn_disable_bg);
    }
    ...
    public void onClick(View v) {
        ...
        if(v == mCategoryLayout) {
            ...
            FeedbackHelper.getInstance().tryCommit(mCategory.getText().toString(), mEditEmail.getText().toString().trim(), mEditContent.getText().toString().trim());
            showMessageDialog(getString(R.string.feedback_success_title), getString(R.string.feedback_success_content));
