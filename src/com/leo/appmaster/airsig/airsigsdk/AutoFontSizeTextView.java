...
//	private boolean mPreventShortLastLine = true;
	
	private static final int NO_LINE_LIMIT = -1;
	private final float default_min_text_size = 20;
	...
	public AutoFontSizeTextView(Context context, AttributeSet attrs, int defStyle) {
	    super(context, attrs, defStyle);
	    
	    TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.com_airsig_AutoFontSizeTextView, defStyle, 0);
	...
	protected void initByAttributes(TypedArray attributes) {
		...
		mMinTextSize = attributes.getFloat(R.styleable.com_airsig_AutoFontSizeTextView_min_font_size, default_min_text_size);
	...
	private void adjustTextSize(final String text) {
		if (!mInitialized || getMeasuredHeight() == 0 || getMeasuredWidth() == 0) {
	        return;
	    }
		...
		if (this.getLayoutParams().width == LayoutParams.WRAP_CONTENT) {
			mWidthLimit = 9999999;
		} else {
