...
public class GestureChangeModeFragment extends BaseFragment implements
        ...
        if (mInputCount == 1) {
            ...
            if (mTempGesture2.equals(mTempGesture1)) {
                ...
                if (pref.getLockType() == AppMasterPreference.LOCK_TYPE_NONE) {
                    SDKWrapper.addEvent(GestureChangeModeFragment.this.mActivity, SDKWrapper.P1,
                            "first",
                            "usehand");
                }
                ...
                if (((LockChangeModeActivity) mActivity).isResetPasswd()) {
                    ...
                    GestureChangeModeFragment.this.mActivity.sendBroadcast(intent2);
                    return;
                }
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        if (mGotoPasswdProtect) {
            ...
            if (((LockChangeModeActivity) mActivity).mToLockList) {
                ...
                // do nothing
                /*
                 * if (((LockChangeModeActivity) mActivity).mFromQuickMode) { int
                 * modeId = ((LockChangeModeActivity) mActivity).mModeId;
