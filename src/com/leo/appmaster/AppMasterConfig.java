...
public class AppMasterConfig {
	...
	// "http://api.leostat.com/appmaster/apprecommend/list";
	// public static final String CHECK_NEW_BUSINESS_APP =
	// "http://api.leostat.com/appmaster/apprecommend/checkappupdate";
