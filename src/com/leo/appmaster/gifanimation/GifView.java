package com.leo.appmaster.gifanimation;
 ...
 *
 */
public class GifView extends /*Image*/View implements GifAction{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(currentImage.isRecycled() || currentImage == null){
        		return;
        }
    		...
    		while(isRun){
    			if(pause == false){
	    			//if(gifDecoder.parseOk()){
	    				...
	    				if (!isLoopPlay) {
	    				    if (currentImage.equals(gifDecoder.getLastImage())) {
	    				        break;
	    				    }
	    				}
...
//	    			}
    ...
    private void stopGifDecoderTread() {
        if(gifDecoder != null){
            gifDecoder.free();
            gifDecoder= null;
        }
    ...
    public void setLoopDisplay(boolean isLoop) {
        isLoopPlay = isLoop;
    }
}
