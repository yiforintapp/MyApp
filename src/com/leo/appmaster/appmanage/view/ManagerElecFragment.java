...
public class ManagerElecFragment extends BaseFragment {
    ...
    protected int layoutResourceId() {
        return R.layout.fragment_manager_elec;
    }
    ...
    protected void onInitUI() {
        ...
        listView = (ListView) findViewById(R.id.listview_ele);
        
        adapter = new customAdapter();
        listView.setAdapter(adapter);

        info = new BatteryInfoProvider(mActivity);
        info.setMinPercentOfTotal(0.01);
        
        mActivity.registerReceiver(mBatteryInfoReceiver, new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
        getBatteryStats();
    }
    ...
    private BroadcastReceiver mBatteryInfoReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_BATTERY_CHANGED.equals(action)) {
                ...
                String batteryStatus = BatteryUtils.getBatteryStatus(mActivity.getResources(), intent);
