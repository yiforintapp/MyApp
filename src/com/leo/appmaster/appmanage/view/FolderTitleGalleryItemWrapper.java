...
class FolderTitleGalleryItemWrapper extends ViewGroup {
	...
	public FolderTitleGalleryItemWrapper(Context context) {
		super(context);
		this.init();
	}

	public FolderTitleGalleryItemWrapper(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.init();
	}
