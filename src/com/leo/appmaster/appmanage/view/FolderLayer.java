...
public class FolderLayer {
    ...
    // private OnShowBusinessTip mOnShowBusinessTip;
    ...
    // public interface OnShowBusinessTip {
    // public void showBusinessTip();
    // }
    ...
    // public void setOnBusinessTipListener(OnShowBusinessTip onShowBusiness) {
    // this.mOnShowBusinessTip = onShowBusiness;
    // }
    ...
    private void startOpenAnimation(View anchorView, final int type) {
        ...
        as2.setAnimationListener(new AnimationListenerAdapter() {
            ...
            public void onAnimationStart(Animation animation) {
                mIsAnimating = true;
                // mOnShowBusinessTip.showBusinessTip();
            }
    ...
    public void closeFloder() {
        ...
        as1.setAnimationListener(new AnimationListenerAdapter() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mFolderView.setCurrentPosition(1);
                Constants.business_app_tip=false;
            }
        });
