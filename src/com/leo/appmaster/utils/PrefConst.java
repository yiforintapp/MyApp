...
public class PrefConst {
    ...
    //提醒添加快捷方式相关
    public static final String KEY_TOTAL_ENTER_HIDE_PIC = "accumulative_total_enter_hide_pic";
    public static final String KEY_TOTAL_ENTER_HIDE_VIDEO = "accumulative_total_enter_hide_video";
    ...
    public static final String KEY_HAS_CREATE_SHOTCUT_PIC = "has_ask_create_shotcut_hide_pic";
  ...
  // 3.3.2加入黑名单弹窗分享
    ...
    public static final String KEY_AIRSIG_REPORT = "airsig_report";
}
