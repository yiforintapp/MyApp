...
public class CircleAnimView extends View {
    ...
    public CircleAnimView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        AppMasterPreference pref = AppMasterPreference.getInstance(getContext());
    ...
    private void computeCirlceBounds(int width, int height) {
        ...
        mOuterCircleBound.set(centerX - outerR, centerY - outerR, centerX + outerR, centerY + outerR);
        ...
        mInnerCircleBound.set(centerX - innerR, centerY - innerR, centerX + innerR, centerY + innerR);
        ...
        mContentBound.set(mInnerCircleBound.left + offset, mInnerCircleBound.top + offset, mInnerCircleBound.right - offset, mInnerCircleBound.bottom - offset);
        ...
        if(mCount > 0) {
            ...
            mLockIconFinalBound.set(iconLeft, iconTop, iconLeft + mIconBigSize, iconTop + mIconBigSize);
        ...
        mTipTextPoint.set(mContentBound.left + (((mContentBound.width() - textSize) / 2)), mLockIconFinalBound.bottom + mTextVerrticalPadding + textH);
    ...
    public void draw(Canvas canvas) {
        ...
        if(mShoudDraw && mLockTextAlpha > 0) {  // draw text
            if(mCount > 0) {
               ...
               canvas.drawText(String.valueOf(mCount), mCountTextPoint.x, mCountTextPoint.y, mPaint);
            }
        ...
        mLockAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if(percent < 0.2f) {
                    ...
                    int left = mLockIconInitBound.left + (int) Math.round(((mLockIconFinalBound.left - mLockIconInitBound.left) * realPercent));
                    int top = mLockIconInitBound.top + (int) Math.round(((mLockIconFinalBound.top - mLockIconInitBound.top) * realPercent));
                ...
                int animR = mMaxAnimCircleR + (int) Math.round((((mInnerCircleBound.width() / 2) - mMaxAnimCircleR) * percent));
                mAnimCircleBound.set(centerX - animR, centerY - animR, centerX +animR , centerY + animR);
