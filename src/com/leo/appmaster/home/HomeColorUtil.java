...
//    public static ColorHolder sColorOrange = new ColorHolder(0xfe, 0xb9, 0x00);
    /*UI对橙色的调整*/
    public static int DEFAULT_COLOR_ORANGE = 0xff8920;
    public static ColorHolder sColorOrange = new ColorHolder(0xff, 0x89, 0x20);
    // 金色
//    public static int DEFAULT_COLOR_GOLDEN = 0xffd700;
//    public static ColorHolder sColorGolden = new ColorHolder(0xff, 0xd7, 0x00);
    /*UI对金色的调整*/
    public static int DEFAULT_COLOR_GOLDEN = 0xf5ad00;
    public static ColorHolder sColorGolden = new ColorHolder(0xf5, 0xad, 0x00);
    // 绿色
