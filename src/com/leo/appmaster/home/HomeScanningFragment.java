...
//                ThreadManager.executeOnSubThread(runnable)
            ...
            ADEngineWrapper.getInstance(mActivity).loadAd(mAdSource, AD_AFTER_SCAN,
                    new ADEngineWrapper.WrappedAdListener() {
                        ...
                        public void onWrappedAdClick(WrappedCampaign campaign, String unitID) {
                            ...
                            SDKWrapper.addEvent(HomeScanningFragment.this.getActivity().getApplicationContext(), "max_ad_click", SDKWrapper.P1, "timeOfClick", "ad pos: " + unitID + " click", null);
    ...
    public static class AdPreviewLoaderListener implements ImageLoadingListener {
        ...
        public void onLoadingStarted(String imageUri, View view) {
            SDKWrapper.addEvent(AppMasterApplication.getInstance().getApplicationContext(), "max_ad_load_image", SDKWrapper.P1, "fetchImage", "ad pos: " + AD_AFTER_SCAN + " prepare for load image", null);
        }

        @Override
        public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
            SDKWrapper.addEvent(AppMasterApplication.getInstance().getApplicationContext(), "max_ad_load_image", SDKWrapper.P1, "fetchImage", "ad pos: " + AD_AFTER_SCAN + " load image failed", null);
        }
        ...
        public void onLoadingComplete(String imageUri, View view, final Bitmap loadedImage) {
            ...
            if (loadedImage != null && fragment != null) {
                ...
                SDKWrapper.addEvent(AppMasterApplication.getInstance().getApplicationContext(), "max_ad_load_image", SDKWrapper.P1, "fetchImage", "ad pos: " + AD_AFTER_SCAN + " image size: " + loadedImage.getByteCount(), null);
...
//        mAdLayout = adView;
        ...
        SDKWrapper.addEvent(AppMasterApplication.getInstance(), "max_ad_ad_show", SDKWrapper.P1, "timeToAdShow", "ad pos: " + AD_AFTER_SCAN + " adShow", null);
    }
    /* 3.2 advertise end */
