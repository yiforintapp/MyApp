...
import com.leo.imageloader.cache.DiskCache;
import com.leo.imageloader.cache.FileNameGenerator;
import com.leo.imageloader.cache.FuzzyKeyMemoryCache;
import com.leo.imageloader.cache.MemoryCache;
import com.leo.imageloader.core.BitmapProcessor;
...
import com.leo.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.leo.imageloader.cache.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.leo.imageloader.core.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.leo.imageloader.cache.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.leo.imageloader.cache.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.leo.imageloader.cache.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.leo.imageloader.cache.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.leo.imageloader.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.leo.imageloader.cache.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.leo.imageloader.cache.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.leo.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.leo.imageloader.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.leo.imageloader.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.leo.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.leo.imageloader.core.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
