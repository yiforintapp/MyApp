 ...
 */
public class WordNoticeFragmentAdapter extends BaseAdapter {
    ...
    public WordNoticeFragmentAdapter(Context context) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.word_notice_item, null);
            holder = new ViewHolder();
            holder.mContent = (TextView) convertView.findViewById(R.id.notice);
