...
public class LeoSettings {
    ...
    private static com.zlf.appmaster.db.ISettings mDatabase = new DatabaseSettings();
    private static com.zlf.appmaster.db.ISettings mPreference = new SharedSettings();
    ...
    public static synchronized void initialize() {
        ...
        for (String s : values.keySet()) {
            ...
            if (com.zlf.appmaster.db.ISettings.isHighPriority(s)) {
        ...
        if (highPriority.size() > 0) {
            mPreference.setBundleMap(highPriority, new com.zlf.appmaster.db.ISettings.OnBundleSavedListener() {
                @Override
        ...
        if (normal.size() > 0) {
            mDatabase.setBundleMap(normal, new com.zlf.appmaster.db.ISettings.OnBundleSavedListener() {
                @Override
                public void onBundleSaved() {
    ...
    private static com.zlf.appmaster.db.ISettings getSettings(String key) {
        if (com.zlf.appmaster.db.ISettings.isHighPriority(key)) {
            return mPreference;
        }
