 ...
 */
public class StockSHFFragment extends BaseFragment {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (null != item) {
                    ...
                    intent.putExtra(StockIndexDetailActivity.INTENT_FLAG_TAB_MINITE_WHAT, Constants.SHF_INFO_MINUTE_PRONAME);
                    intent.putExtra(StockIndexDetailActivity.INTENT_FLAG_TAB_KLINE_WHAT, Constants.SHF_INFO_KLINE_PRONAME);
    ...
    private void requestData(){
        ...
        }, Constants.MY_DATA_URL.concat(Constants.SHANG_HAI_FUTURES_INFO_PRONAME));
...
//        MobclickAgent.onPageEnd( TAG );
    ...
    public void toRequestDate() {
        if (isInUrFace) {
            LeoLog.d("TimeService", "SHFF Fragment request");
            isFlash = true;
            requestData();
        }
    }
