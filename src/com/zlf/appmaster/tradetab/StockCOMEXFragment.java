...
public class StockCOMEXFragment extends BaseFragment {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (null != item) {
                    ...
                    intent.putExtra(StockIndexDetailActivity.INTENT_FLAG_TAB_MINITE_WHAT, Constants.COMEX_INFO_MINUTE_PRONAME);
                    intent.putExtra(StockIndexDetailActivity.INTENT_FLAG_TAB_KLINE_WHAT, Constants.COMEX_INFO_KLINE_PRONAME);
    ...
    private void requestData() {
        ...
        }, Constants.MY_DATA_URL.concat(Constants.COMEX_INFO_PRONAME));
