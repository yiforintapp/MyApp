 ...
 */
public class StockNYMEXFragment extends BaseFragment {
    ...
    private void requestData(){
        ...
        }, Constants.MY_DATA_URL.concat(Constants.NYMEX_INFO_PRONAME));
...
//        MobclickAgent.onPageEnd( TAG );
    ...
    public void toRequestDate() {
        if (isInUrFace) {
            LeoLog.d("TimeService", "NYMEX Fragment request");
            isFlash = true;
            requestData();
        }
    }
