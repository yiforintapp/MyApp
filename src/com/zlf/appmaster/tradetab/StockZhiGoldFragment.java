        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (null != item) {
                    ...
                    intent.putExtra(StockIndexDetailActivity.INTENT_FLAG_TAB_MINITE_WHAT, Constants.ZHI_GOLD_INFO_MINUTE_PRONAME);
                    intent.putExtra(StockIndexDetailActivity.INTENT_FLAG_TAB_KLINE_WHAT, Constants.ZHI_GOLD_INFO_KLINE_PRONAME);
...
//        MobclickAgent.onPageEnd( TAG );
    ...
    public void toRequestDate() {
        if (isInUrFace) {
            LeoLog.d("TimeService", "ZHIGOLD Fragment request");
            isFlash = true;
            requestData();
        }
    }
