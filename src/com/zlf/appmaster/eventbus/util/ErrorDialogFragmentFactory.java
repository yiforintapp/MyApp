package com.zlf.appmaster.eventbus.util;
...
public abstract class ErrorDialogFragmentFactory<T> {
    protected final com.zlf.appmaster.eventbus.util.ErrorDialogConfig config;

    protected ErrorDialogFragmentFactory(com.zlf.appmaster.eventbus.util.ErrorDialogConfig config) {
        this.config = config;
    }
    ...
    public static class Support extends ErrorDialogFragmentFactory<Fragment> {
        ...
        public Support(com.zlf.appmaster.eventbus.util.ErrorDialogConfig config) {
            super(config);
        }
    ...
    public static class Honeycomb extends ErrorDialogFragmentFactory<android.app.Fragment> {
        ...
        public Honeycomb(com.zlf.appmaster.eventbus.util.ErrorDialogConfig config) {
            super(config);
        }
