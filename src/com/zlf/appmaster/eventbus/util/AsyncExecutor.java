...
public class AsyncExecutor {
    ...
    public static class Builder {
        ...
        public Builder eventBus(LeoEventBus eventBus) {
        ...
        public AsyncExecutor buildForScope(Object executionContext) {
            if (eventBus == null) {
                eventBus = LeoEventBus.getDefaultBus();
            }
            if (threadPool == null) {
    ...
    private final LeoEventBus eventBus;
    private final Object scope;

    private AsyncExecutor(Executor threadPool, LeoEventBus eventBus, Class<?> failureEventType, Object scope) {
        this.threadPool = threadPool;
        this.eventBus = eventBus;
        this.scope = scope;
        try {
