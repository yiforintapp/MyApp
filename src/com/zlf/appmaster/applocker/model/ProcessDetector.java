...
public class ProcessDetector {
    ...
    private List<com.zlf.appmaster.applocker.model.ProcessAdj> mZygoteList;
...
//    private List<ProcessAdj> mSamePkgList;
    ...
    public ProcessDetector() {
        ...
        mZygoteList = new ArrayList<com.zlf.appmaster.applocker.model.ProcessAdj>();
...
//            p = builder.start();
            ...
            while ((line = br.readLine()) != null) {
                com.zlf.appmaster.applocker.model.ProcessAdj pair = getProcessAdjByFormatedLine(line, zygoteId);
    ...
    public com.zlf.appmaster.applocker.model.ProcessAdj getForegroundProcess() {
        List<com.zlf.appmaster.applocker.model.ProcessAdj> result = new ArrayList<com.zlf.appmaster.applocker.model.ProcessAdj>();
...
//                }
    ...
    public boolean isHomePackage(String pkgName) {
        com.zlf.appmaster.applocker.model.ProcessAdj adj = new com.zlf.appmaster.applocker.model.ProcessAdj();
        adj.pkg = pkgName;
     ...
     * @return
     */
    public boolean isHomePackage(com.zlf.appmaster.applocker.model.ProcessAdj processAdj) {
        return mHomeFilter.filterProcess(processAdj);
    }

    protected com.zlf.appmaster.applocker.model.ProcessAdj filterForegroundProcess(List<com.zlf.appmaster.applocker.model.ProcessAdj> list) {
        if (list == null || list.isEmpty()) return null;

        List<com.zlf.appmaster.applocker.model.ProcessAdj> result = new ArrayList<com.zlf.appmaster.applocker.model.ProcessAdj>(list);
        filterSamePkgList(result);

        Iterator<com.zlf.appmaster.applocker.model.ProcessAdj> iterator = result.iterator();
        com.zlf.appmaster.applocker.model.ProcessAdj adj = null;
        ...
        com.zlf.appmaster.applocker.model.ProcessAdj target = null;
        if (result.size() > 1) {
            com.zlf.appmaster.applocker.model.ProcessDetectorCompat22 detector = new com.zlf.appmaster.applocker.model.ProcessDetectorCompat22();

            iterator = result.iterator();
            while (iterator.hasNext()) {
                com.zlf.appmaster.applocker.model.ProcessAdj processAdj = iterator.next();
    ...
    protected void filterSamePkgList(List<com.zlf.appmaster.applocker.model.ProcessAdj> adjs) {
        HashMap<String, Integer> map = new HashMap<String, Integer>();
        List<String> has2SamePkgList = new ArrayList<String>();
        Iterator<com.zlf.appmaster.applocker.model.ProcessAdj> iterator = adjs.iterator();
        while (iterator.hasNext()) {
            com.zlf.appmaster.applocker.model.ProcessAdj processAdj = iterator.next();
        ...
        List<com.zlf.appmaster.applocker.model.ProcessAdj> needToRemove = new ArrayList<com.zlf.appmaster.applocker.model.ProcessAdj>();
        for (String pkg : has2SamePkgList) {
            com.zlf.appmaster.applocker.model.ProcessAdj preAdj = null;
     ...
     * @return
     */
    private boolean isZygoteSon(com.zlf.appmaster.applocker.model.ProcessAdj processAdj) {
        // 部分机型找不到zygote列表，所以需要返回true
        if (mZygoteList.isEmpty()) return true;

        for (com.zlf.appmaster.applocker.model.ProcessAdj zygote : mZygoteList) {
...
//    }
    ...
    public static boolean isUsageAvailable() {
        com.zlf.appmaster.applocker.model.ProcessDetectorUsageStats usageStats = new com.zlf.appmaster.applocker.model.ProcessDetectorUsageStats();
        return usageStats.checkAvailable();
    }

    public static interface ProcessFilter {
        public boolean filterProcess(com.zlf.appmaster.applocker.model.ProcessAdj processAdj);
    }
