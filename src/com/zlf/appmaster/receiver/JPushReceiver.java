package com.zlf.appmaster.receiver;
...
import com.zlf.appmaster.home.DayNewsListActivty;
...
//        	context.startActivity(i);
    ...
    private void clickNotify(Bundle bundle, Context context) {
        if (bundle != null) {
                ...
                if (key.equals(JPushInterface.EXTRA_EXTRA) && !bundle.getString(JPushInterface.EXTRA_EXTRA).isEmpty()) {
                    try {
                        ...
                        while (it.hasNext()) {
                            ...
                            gotoActivity(myKey, myValue, context);
                            break;
                        }
...
//        	context.startActivity(i);
    ...
    private void gotoActivity(String myKey, String myValue, Context context) {
        if (myKey != null && !myKey.isEmpty()) {
            Intent intent;
            if (myKey.equals(Constants.PUSH_KEY_DAYNEWS)) {
                intent = new Intent(context, DayNewsListActivty.class);
