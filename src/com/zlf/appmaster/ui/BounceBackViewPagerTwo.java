 ...
 */
public class BounceBackViewPagerTwo extends ViewPager {
    ...
    public BounceBackViewPagerTwo(Context context) {
        super(context);
    }

    public BounceBackViewPagerTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
