...
import com.zlf.imageloader.core.FailReason;
import com.zlf.imageloader.core.FlushedInputStream;
import com.zlf.imageloader.core.ImageAware;
import com.zlf.imageloader.core.ImageLoadingListener;
import com.zlf.imageloader.core.ImageLoadingProgressListener;
import com.zlf.imageloader.core.ImageSize;
import com.zlf.imageloader.core.ImageViewAware;
import com.zlf.imageloader.core.LoadedFrom;
import com.zlf.imageloader.core.NonViewAware;
import com.zlf.imageloader.core.SimpleImageLoadingListener;
import com.zlf.imageloader.core.ViewScaleType;
import com.zlf.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
     ...
     * @param imageAware {@linkplain com.zlf.imageloader.core.ImageAware Image
     ...
     * @param imageAware {@linkplain com.zlf.imageloader.core.ImageAware Image
     *                   aware view} which should display image
     * @param options    {@linkplain com.zlf.imageloader.DisplayImageOptions
     ...
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
    public void displayImage(String uri, ImageAware imageAware, com.zlf.imageloader.DisplayImageOptions options) {
     ...
     *                         loading process. Listener fires events on UI thread if this
     *                         method is called on UI thread.
     * @param progressListener {@linkplain com.zlf.imageloader.core.ImageLoadingProgressListener
     ...
     *                         {@linkplain com.zlf.imageloader.DisplayImageOptions options}
     ...
     * @throws IllegalArgumentException if passed <b>imageView</b> is null
     */
    public void displayImage(String uri, ImageView imageView, com.zlf.imageloader.DisplayImageOptions options) {
        displayImage(uri, new ImageViewAware(imageView), options, null, null);
    }

    public void displayImage(String uri, ImageView imageView, com.zlf.imageloader.DisplayImageOptions options, ImageSize imageSize) {
     ...
     *                               method wasn't called before
     */
    public void loadImage(String uri, com.zlf.imageloader.DisplayImageOptions options, ImageLoadingListener listener) {
     ...
     *                               method wasn't called before
     */
    public void loadImage(String uri, ImageSize targetImageSize, com.zlf.imageloader.DisplayImageOptions options,
                          ImageLoadingListener listener) {
     ...
     *                               method wasn't called before
     */
    public Bitmap loadImageSync(String uri, com.zlf.imageloader.DisplayImageOptions options) {
     ...
     *                               method wasn't called before
     */
    public Bitmap loadImageSync(String uri, ImageSize targetImageSize, com.zlf.imageloader.DisplayImageOptions options) {
        if (options == null) {
            options = configuration.defaultDisplayImageOptions;
        }
        options = new com.zlf.imageloader.DisplayImageOptions.Builder().cloneFrom(options).syncLoading(true).build();
    ...
    private void checkConfiguration() {
        if (configuration == null) {
            boolean isLoggable = AppMasterConfig.LOGGABLE;
            if (isLoggable) {
                throw new IllegalStateException(ERROR_NOT_INIT);
            } else {
                LeoLog.e(TAG, ERROR_NOT_INIT);
            }
        }
    }
     ...
     * {@link com.zlf.imageloader.core.ImageAware ImageAware}
     */
     ...
     * {@link com.zlf.imageloader.core.ImageAware ImageAware}.
     *
     * @param imageAware {@link com.zlf.imageloader.core.ImageAware ImageAware}
     ...
     * {@linkplain com.zlf.imageloader.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
    ...
    private static Handler defineHandler(com.zlf.imageloader.DisplayImageOptions options) {
