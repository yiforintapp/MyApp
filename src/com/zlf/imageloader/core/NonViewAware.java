 ...
 * com.zlf.imageloader.core.ImageLoadingListener#onLoadingComplete(String, android.view.View,
 * android.graphics.Bitmap) callback}.
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 * @since 1.9.0
 */
public class NonViewAware implements com.zlf.imageloader.core.ImageAware {

	protected final String imageUri;
	protected final com.zlf.imageloader.core.ImageSize imageSize;
	protected final ViewScaleType scaleType;

	public NonViewAware(com.zlf.imageloader.core.ImageSize imageSize, ViewScaleType scaleType) {
		this(null, imageSize, scaleType);
	}

	public NonViewAware(String imageUri, com.zlf.imageloader.core.ImageSize imageSize, ViewScaleType scaleType) {
