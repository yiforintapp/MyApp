 ...
 * @since 1.9.1
 */
public class RoundedVignetteBitmapDisplayer extends com.zlf.imageloader.core.RoundedBitmapDisplayer {
	...
	@Override
	public void display(Bitmap bitmap, com.zlf.imageloader.core.ImageAware imageAware, com.zlf.imageloader.core.LoadedFrom loadedFrom) {
		if (!(imageAware instanceof com.zlf.imageloader.core.ImageViewAware)) {
