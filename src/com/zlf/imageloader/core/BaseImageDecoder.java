...
import com.zlf.appmaster.cloud.crypto.ImageEncryptInputStream;
...
public class BaseImageDecoder implements ImageDecoder {
     ...
     *            {@link com.zlf.imageloader.ImageLoaderConfiguration.Builder#writeDebugLogs()
    ...
    protected Bitmap considerExactScaleAndOrientatiton(Bitmap subsampledBitmap,
        ...
        Bitmap finalBitmap = Bitmap.createBitmap(subsampledBitmap, 0, 0,
                subsampledBitmap.getWidth(), subsampledBitmap
                        .getHeight(), m, true);
