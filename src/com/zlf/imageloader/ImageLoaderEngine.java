...
class ImageLoaderEngine {
	...
	final com.zlf.imageloader.ImageLoaderConfiguration configuration;
	...
	ImageLoaderEngine(com.zlf.imageloader.ImageLoaderConfiguration configuration) {
...
//		taskDistributor = DefaultConfigurationFactory.createTaskDistributor();
	...
	private Executor createTaskExecutor() {
		return com.zlf.imageloader.DefaultConfigurationFactory
				.createExecutor(configuration.threadPoolSize, configuration.threadPriority,
				configuration.tasksProcessingType);
	}

	/**
	 * Returns URI of image which is loading at this moment into passed {@link com.zlf.imageloader.core.ImageAware}
	 */
	 ...
	 *
	 * @param imageAware {@link com.zlf.imageloader.core.ImageAware} for which display task
	 *                   will be cancelled
	 */
