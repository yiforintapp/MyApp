...
import com.zlf.imageloader.core.ImageDownloader.Scheme;
...
import com.zlf.imageloader.core.FailReason.FailType;
import com.zlf.imageloader.core.ImageAware;
import com.zlf.imageloader.core.ImageDecodingInfo;
 ...
 * {@link com.zlf.imageloader.core.ImageAware} using {@link DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    // Helper references
    private final com.zlf.imageloader.ImageLoaderConfiguration configuration;
    ...
    final com.zlf.imageloader.DisplayImageOptions options;
    ...
    public void run() {
        ...
        try {
            ...
            LeoLog.d(com.zlf.imageloader.ImageLoader.TAG, "load mem bmp: " + bmp + " | memoryCacheKey: " + memoryCacheKey);
            if (bmp == null || bmp.isRecycled()) {
                bmp = tryLoadBitmap();
                LeoLog.d(com.zlf.imageloader.ImageLoader.TAG, "try load bmp: " + bmp + " | memoryCacheKey: " + memoryCacheKey);
                if (bmp == null)
    ...
    private boolean resizeAndSaveImage(int maxWidth, int maxHeight) throws IOException {
        ...
        if (targetFile != null && targetFile.exists()) {
            ...
            com.zlf.imageloader.DisplayImageOptions specialOptions = new com.zlf.imageloader.DisplayImageOptions.Builder()
                    .cloneFrom(options)
