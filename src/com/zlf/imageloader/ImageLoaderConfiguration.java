 ...
 *******************************************************************************/
package com.zlf.imageloader;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import com.zlf.imageloader.cache.DiskCache;
import com.zlf.imageloader.cache.FileNameGenerator;
import com.zlf.imageloader.cache.FuzzyKeyMemoryCache;
import com.zlf.imageloader.cache.MemoryCache;
import com.zlf.imageloader.core.BitmapProcessor;
import com.zlf.imageloader.core.FlushedInputStream;
import com.zlf.imageloader.core.ImageDecoder;
import com.zlf.imageloader.core.ImageDownloader;
import com.zlf.imageloader.core.ImageSize;
import com.zlf.imageloader.core.QueueProcessingType;
import com.zlf.imageloader.utils.L;
import com.zlf.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	...
	final com.zlf.imageloader.DisplayImageOptions defaultDisplayImageOptions;
	 ...
	 * <li>diskCache = {@link com.zlf.imageloader.cache.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		private com.zlf.imageloader.DisplayImageOptions defaultDisplayImageOptions = null;
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.zlf.imageloader.core.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.zlf.imageloader.cache.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.zlf.imageloader.cache.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.zlf.imageloader.cache.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.zlf.imageloader.cache.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.zlf.imageloader.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.zlf.imageloader.cache.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.zlf.imageloader.cache.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.zlf.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.zlf.imageloader.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.zlf.imageloader.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 */
		public Builder defaultDisplayImageOptions(com.zlf.imageloader.DisplayImageOptions defaultDisplayImageOptions) {
		 ...
		 * Consider {@link com.zlf.imageloader.utils.L#disableLogging()} to disable
		...
		private void initEmptyFieldsWithDefaultValues() {
			if (taskExecutor == null) {
				taskExecutor = com.zlf.imageloader.DefaultConfigurationFactory
						.createExecutor(threadPoolSize, threadPriority, tasksProcessingType);
			} else {
				customExecutor = true;
			}
			if (taskExecutorForCachedImages == null) {
				taskExecutorForCachedImages = com.zlf.imageloader.DefaultConfigurationFactory
						.createExecutor(threadPoolSize, threadPriority, tasksProcessingType);
			} else {
			...
			if (diskCache == null) {
				if (diskCacheFileNameGenerator == null) {
					diskCacheFileNameGenerator = com.zlf.imageloader.DefaultConfigurationFactory.createFileNameGenerator();
				}
				diskCache = com.zlf.imageloader.DefaultConfigurationFactory
						.createDiskCache(context, diskCacheFileNameGenerator, diskCacheSize, diskCacheFileCount);
			}
			if (memoryCache == null) {
				memoryCache = com.zlf.imageloader.DefaultConfigurationFactory.createMemoryCache(context, memoryCacheSize);
			}
			if (denyCacheImageMultipleSizesInMemory) {
				memoryCache = new FuzzyKeyMemoryCache(memoryCache, MemoryCacheUtils.createFuzzyKeyComparator());
			}
			if (downloader == null) {
				downloader = com.zlf.imageloader.DefaultConfigurationFactory.createImageDownloader(context);
			}
			if (decoder == null) {
				decoder = com.zlf.imageloader.DefaultConfigurationFactory.createImageDecoder(writeLogs);
			}
			if (defaultDisplayImageOptions == null) {
				defaultDisplayImageOptions = com.zlf.imageloader.DisplayImageOptions.createSimple();
			}
		}
	}
	 ...
	 * using {@link com.zlf.imageloader.core.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
