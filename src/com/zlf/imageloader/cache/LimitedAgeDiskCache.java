...
import com.zlf.imageloader.DefaultConfigurationFactory;
 ...
 * @since 1.3.1
 */
public class LimitedAgeDiskCache extends com.zlf.imageloader.cache.BaseDiskCache {
	 ...
	 *                          treatment (and therefore be reloaded).
	 */
	public LimitedAgeDiskCache(File cacheDir, File reserveCacheDir, com.zlf.imageloader.cache.FileNameGenerator fileNameGenerator, long maxAge) {
