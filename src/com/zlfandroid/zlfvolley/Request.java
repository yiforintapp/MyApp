...
import com.zlfandroid.zlfvolley.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	private final com.zlfandroid.zlfvolley.Response.ErrorListener mErrorListener;

	/** Sequence number of this request, used to enforce FIFO ordering. */
	private Integer mSequence;

	/** The request queue this request is associated with. */
	private com.zlfandroid.zlfvolley.RequestQueue mRequestQueue;
	 ...
	 * cache.
	 */
	private com.zlfandroid.zlfvolley.Cache.Entry mCacheEntry = null;
	 ...
	 * 
	 * @deprecated Use
	 *             {@link #Request(int, String, com.zlfandroid.zlfvolley.Response.ErrorListener)}
	 *             .
	 */
	@Deprecated
	public Request(String url, com.zlfandroid.zlfvolley.Response.ErrorListener listener) {
	 ...
	 * response.
	 */
	public Request(int method, String url, com.zlfandroid.zlfvolley.Response.ErrorListener listener) {
		mMethod = method;
		mUrl = url;
	 ...
	 * tag by {@link com.zlfandroid.zlfvolley.RequestQueue#cancelAll(Object)}.
	 * 
	...
	/**
	 * @return this request's {@link com.zlfandroid.zlfvolley.Response.ErrorListener}.
	 */
	public com.zlfandroid.zlfvolley.Response.ErrorListener getErrorListener() {
	...
	void finish(final String tag) {
		...
		if (MarkerLog.ENABLED) {
			...
			if (requestTime >= SLOW_REQUEST_THRESHOLD_MS) {
				com.zlfandroid.zlfvolley.VolleyLog.d("%d ms: %s", requestTime, this.toString());
			}
		}
	}
	 ...
	 * @return This Request object to allow for chaining.
	 */
	public Request<?> setRequestQueue(com.zlfandroid.zlfvolley.RequestQueue requestQueue) {
		mRequestQueue = requestQueue;
		return this;
	}

	/**
	 * Sets the sequence number of this request. Used by {@link com.zlfandroid.zlfvolley.RequestQueue}.
	 * 
	 * @return This Request object to allow for chaining.
	 */
	 ...
	 * @return This Request object to allow for chaining.
	 */
	public Request<?> setCacheEntry(com.zlfandroid.zlfvolley.Cache.Entry entry) {
		mCacheEntry = entry;
		return this;
	}
	 ...
	 */
	public com.zlfandroid.zlfvolley.Cache.Entry getCacheEntry() {
		return mCacheEntry;
	}
...
//		return Collections.emptyMap();
	 ...
	 * cause delivery of a {@link com.zlfandroid.zlfvolley.TimeoutError} error.
	 */
	 ...
	 */
	abstract protected com.zlfandroid.zlfvolley.Response<T> parseNetworkResponse(NetworkResponse response);
	 ...
	 */
	protected com.zlfandroid.zlfvolley.VolleyError parseNetworkError(com.zlfandroid.zlfvolley.VolleyError volleyError) {
		return volleyError;
	}
	 ...
	 *            Error details
	 */
	public void deliverError(com.zlfandroid.zlfvolley.VolleyError error) {
