 ...
 */
public class StringRequest extends com.zlfandroid.zlfvolley.Request<String> {
    ...
    @Override
    protected Response<String> parseNetworkResponse(com.zlfandroid.zlfvolley.NetworkResponse response) {
        String parsed;
        try {
