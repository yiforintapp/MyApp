...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        // track it.
        com.zlfandroid.zlfvolley.Request<Bitmap> newRequest = makeImageRequest(requestUrl, maxWidth, maxHeight, cacheKey);
    ...
    protected com.zlfandroid.zlfvolley.Request<Bitmap> makeImageRequest(String requestUrl, int maxWidth, int maxHeight, final String cacheKey) {
    ...
    private class BatchedImageRequest {
        ...
        private final com.zlfandroid.zlfvolley.Request<?> mRequest;
         ...
         */
        public BatchedImageRequest(com.zlfandroid.zlfvolley.Request<?> request, ImageContainer container) {
            mRequest = request;
